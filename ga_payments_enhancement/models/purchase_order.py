...
class PurchaseOrder(models.Model):
    ...
    journal_entry = fields.Many2one('account.move','Journal Entry', store=True)

    payment_entry_ref = fields.One2many('account.payment', 'purchase_id', string='Payment Reference')